...
const administrasjonMeny = [
  ...
  ['FEIL_REGISTRER_KRAV_OG_OPPGAVE', '/feil-registrer-krav-og-oppgave', 'Feilregistrer krav og oppgave'],
]
...
const batcherMeny = [
  ...
  ['SAMORDNING_SKRIV', '/send-til-samordning', 'Send til samordning'],
...
const behandlingerMeny = [
  ['SE_BEHANDLINGER', '/behandlinger/antall', 'Antall etter type'],
