        ...
        <FormSummary.Answers>
            ...
            <HGrid columns={3} gap="space-40">
              ...
              <FormSummary.Value>
                <FormSummary.Answers>
                  ...
                  <FormSummary.Answer>
                    <FormSummary.Label>Skal bruke kjøreplan</FormSummary.Label>
                    <FormSummary.Value>{props.skalBrukeKjoreplan ? 'Ja' : 'Nei'}</FormSummary.Value>
                  </FormSummary.Answer>
                </FormSummary.Answers>
              </FormSummary.Value>
            </HGrid>
          ...
          <FormSummary.Answer>
            ...
            <FormSummary.Value>
              <FormSummary.Answers>
                <FormSummary.Answer>
                  <FormSummary.Label>Brevstrategi</FormSummary.Label>
                  <FormSummary.Value>{props.brevstrategi}</FormSummary.Value>
                </FormSummary.Answer>
              </FormSummary.Answers>
            </FormSummary.Value>
            {(props.brevstrategi === 'ALLE' || props.brevstrategi === 'KUN_ENDRET') && (
              <HGrid columns={2} gap="space-40">
                <FormSummary.Value>
                  <FormSummary.Answers>
                    {props.selectedBrevkodeSokerAlderGammeltRegelverk &&
                      props.selectedBrevkodeSokerAlderGammeltRegelverk.value !== 'not set' && (
                        <FormSummary.Answer>
                          ...
                          <FormSummary.Value>
                            {props.selectedBrevkodeSokerAlderGammeltRegelverk.value}
                          </FormSummary.Value>
                        </FormSummary.Answer>
                      )}
                    ...
                    {props.selectedBrevkodeSokerAFP && props.selectedBrevkodeSokerAFP.value !== 'not set' && (
                      <FormSummary.Answer>
