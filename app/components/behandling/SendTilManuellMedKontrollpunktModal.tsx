    ...
    <>
      ...
      <Modal ref={props.modalRef} header={{ heading: 'Manuell behandling' }} placement="top">
        <Modal.Body style={{ minHeight: '550px' }}>
          ...
          på kravet og det vil bli opprettet en oppgave med oppgitt kontrollpunkt. Det er ikke mulig å angre denne
          handlingen
        ...
        <Modal.Footer>
          ...
          <Button type="button" variant="secondary" onClick={() => props.modalRef.current?.close()}>
            Avbryt
          </Button>
        </Modal.Footer>
      </Modal>
