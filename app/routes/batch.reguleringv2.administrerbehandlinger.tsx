...
export default function AdministrerTilknyttetdeBehandlinger() {
  ...
  return (
    <VStack gap="5">
      ...
      <ConfirmationModal text="Er du sikker på at du vil fortsette familiebehandlinger som er utsatt? Dette vil nullstille utsattTil-tidspunkt for alle ikke-feilende familiebehandlinger." showModal={openConfirmationModal === "fortsettFamilieReguleringerTilBehandling"} onOk={() => {fortsettFamilieReguleringerTilBehandling()}} onCancel={() => setOpenConfirmationModal(null)} />
      <ConfirmationModal text="Er du sikker på at du vil fortsette feilende familiebehandlinger? Dette vil nullstille utsattTil-tidspunkt for alle feilende familiebehandlinger." showModal={openConfirmationModal === "fortsettFeilendeFamiliereguleringer"} onOk={() => {fortsettFeilendeFamilieReguleringer()}} onCancel={() => setOpenConfirmationModal(null)} />
      <ConfirmationModal text="Er du sikker på at du vil fortsette feilende iverksett-vedtak-behandlinger? Dette vil nullstille utsattTil-tidspunkt for alle feilende iverksett-vedtak-behandlinger." showModal={openConfirmationModal === "fortsettFeilendeIverksettVedtak"} onOk={() => {fortsettFeilendeIverksettVedtak()}} onCancel={() => setOpenConfirmationModal(null)} />
      <ConfirmationModal text="Er du sikker på at du vil gjenoppta kjøring med nye avviksgrenser? Familiebehandlinger som har gått ut på avviksgrenser vil kjøre fra BeregnYtelser-aktiviteten på nytt og hente opp nåværende avviksgrenser." showModal={openConfirmationModal === "fortsettNyAvviksgrenser"} onOk={() => {fortsettNyAvviksgrenser()}} onCancel={() => setOpenConfirmationModal(null)} />
      <ConfirmationModal text="Er du sikker på at du vil kjøre i faktoromregningsmodus? Dette gjør at faktoromregning tillattes for familiebehandlinger som har gått ut med beregningsavvik." showModal={openConfirmationModal === "fortsettFaktoromregningsmodus"} onOk={() => {fortsettFaktoromregningsmodus()}} onCancel={() => setOpenConfirmationModal(null)} />
      <ConfirmationModal text="Er du sikker på at du vil kjøre i feilhåndteringsmodus? Dette gjør at forenklet beregning og faktoromregning gjøres for familiebehandlinger som har feilet i BeregnYtelser-aktiviteten." showModal={openConfirmationModal === "fortsettFeilhandteringmodus"} onOk={() => {fortsettFeilhandteringmodus()}} onCancel={() => setOpenConfirmationModal(null)} />
    </VStack>
  )
}
