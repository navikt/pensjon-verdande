    ...
    <VStack gap="5">
      ...
      <VStack gap="5">
        <Textarea
          ...
          value={saksnummerListe}
          onChange={(e) => setSaksnummerListe(e.target.value)}
          minRows={30}
          style={{ width: '30em' }}
          resize
        />
        ...
        <div>
          <Button type="submit" loading={fetcher.state === 'submitting'} onClick={onSubmit}>
            Oppdater ekskluderte saker
          </Button>
        </div>
      </VStack>
    </VStack>
