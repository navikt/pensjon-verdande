...
export function mockKravStatistikkData(): import('./types').KravStatistikkResponse {
  return {
    krav: [
      {
      ...
      },
      {
        ...
        kravStatus: 'FERDIG',
        behandlingType: 'MAN',
        vedtakStatus: 'AVSLATT',
        alder: 65,
        antall: 50,
        gjennomsnittDager: 22.3,
        medianDager: 19.0,
        p90Dager: 40.0,
        p95Dager: 50.0,
      },
...
export function mockSaksbehandlingstidData(): import('./types').SaksbehandlingstidResponse {
  return {
    datapunkter: [
      {
        periodeFra: '2026-01-01T00:00:00',
        antall: 120,
        gjennomsnittDager: 14.5,
        medianDager: 10.0,
        p90Dager: 30.0,
        p95Dager: 45.0,
      },
...
export function mockBehandlingstidPerTypeData(): import('./types').BehandlingstidPerTypeResponse {
  return {
    datapunkter: [
      {
        periodeFra: '2026-01-01T00:00:00',
...
export function mockKravTidsserieData(): import('./types').KravTidsserieResponse {
  return {
    datapunkter: [
      { periodeFra: '2026-01-01T00:00:00', sakType: 'ALDER', behandlingType: 'AUTO', antall: 300 },
      { periodeFra: '2026-01-01T00:00:00', sakType: 'ALDER', behandlingType: 'DEL_AUTO', antall: 120 },
      { periodeFra: '2026-01-01T00:00:00', sakType: 'ALDER', behandlingType: 'MAN', antall: 80 },
      { periodeFra: '2026-01-01T00:00:00', sakType: 'UFOREP', behandlingType: 'AUTO', antall: 200 },
      { periodeFra: '2026-01-01T00:00:00', sakType: 'UFOREP', behandlingType: 'MAN', antall: 100 },
      { periodeFra: '2026-02-01T00:00:00', sakType: 'ALDER', behandlingType: 'AUTO', antall: 350 },
      { periodeFra: '2026-02-01T00:00:00', sakType: 'ALDER', behandlingType: 'DEL_AUTO', antall: 110 },
      { periodeFra: '2026-02-01T00:00:00', sakType: 'ALDER', behandlingType: 'MAN', antall: 90 },
      { periodeFra: '2026-02-01T00:00:00', sakType: 'UFOREP', behandlingType: 'AUTO', antall: 180 },
      { periodeFra: '2026-02-01T00:00:00', sakType: 'UFOREP', behandlingType: 'MAN', antall: 100 },
      { periodeFra: '2026-03-01T00:00:00', sakType: 'ALDER', behandlingType: 'AUTO', antall: 280 },
      { periodeFra: '2026-03-01T00:00:00', sakType: 'ALDER', behandlingType: 'DEL_AUTO', antall: 130 },
      { periodeFra: '2026-03-01T00:00:00', sakType: 'ALDER', behandlingType: 'MAN', antall: 70 },
      { periodeFra: '2026-03-01T00:00:00', sakType: 'UFOREP', behandlingType: 'AUTO', antall: 220 },
      { periodeFra: '2026-03-01T00:00:00', sakType: 'UFOREP', behandlingType: 'MAN', antall: 100 },
    ],
  }
}

export function mockBehandlingKravAlderData(): import('./types').BehandlingKravAlderResponse {
  return {
    rader: [
      {
        sakType: 'ALDER',
        behandlingType: 'ForsteBehAlderBeregning',
        kravGjelder: 'FORSTEGANGSKRAV',
        alder: 63,
        antall: 200,
      },
      {
      ...
      { sakType: 'ALDER', behandlingType: 'RevurderingBehandling', kravGjelder: 'REVURDERING', alder: 65, antall: 120 },
      { sakType: 'ALDER', behandlingType: 'RevurderingBehandling', kravGjelder: 'REVURDERING', alder: 72, antall: 300 },
      {
        sakType: 'UFOREP',
        behandlingType: 'IverksettVedtakBehandling',
        kravGjelder: 'F_BH_MED_FORELDET',
        alder: 45,
        antall: 180,
      },
      {
