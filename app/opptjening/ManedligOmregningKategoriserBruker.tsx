...
export default function ManedligOmregningKategoriserBruker({ denneBehandlingsmaneden }: {
  ...
  return (
    <Box.New
      ...
      borderRadius={'medium'}
    >
      <Heading level={"2"} size={'medium'}>Start omregning av ytelse ved oppdaterte opptjeningsopplysninger</Heading>
