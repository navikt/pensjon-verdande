    ...
    renderWithLayout(
      AldeOppfolging,
      {
        ...
        aktivitetFordelingOverTid: [
          ...
          { dato: '2024-06-12', status: 'UNDER_BEHANDLING', antall: 4 },
        ...
        tilgjengeligeAktivitetTyper: [
          ...
          { kode: 'FleksibelApSak_AldeAttestere', friendlyName: 'Attestere' },
          { kode: 'FleksibelApSak_VurderSamboer', friendlyName: 'Vurder samboer' },
        ],
